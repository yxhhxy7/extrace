...
public class PackageListFragment extends ListFragment implements IDataAdapter<List<TransPackage>>, PositionAdapter<ArrayList<PackageRoute>>, NotifyAdapter<Boolean> {
