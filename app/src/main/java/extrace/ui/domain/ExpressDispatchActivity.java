...
public class ExpressDispatchActivity extends AppCompatActivity implements ActionBar.TabListener, IDataAdapter<ExpressSheet> {
   ...
   SectionsPagerAdapter mSectionsPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_express_dispatch);
    ...
    public static class ExpressEditFragment1 extends Fragment implements IDataAdapter<ExpressSheet>{
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_dispatch_express,
                    container, false);
            ...
            mbtnRcv.setOnClickListener(
                    new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            ((ExpressDispatchActivity) getActivity()).GetCustomer(REQUEST_RCV);
                        }
                    });
            ...
            mbtnSnd.setOnClickListener(
                    new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            ((ExpressDispatchActivity) getActivity()).GetCustomer(REQUEST_SND);
                        }
                    });
